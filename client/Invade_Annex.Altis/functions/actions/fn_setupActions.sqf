...
JEDI_act pushBack (player addAction["<t color='#FF0000'>Repair Vehicle</t>",jedi_fnc_personalRepair,"",99,false,false,"", ' vehicle player == player && !isNull cursorTarget && ((cursorTarget isKindOf "Car") OR (cursorTarget isKindOf "Air") OR (cursorTarget isKindOf "Ship")) && (player distance cursorTarget < 6)']);
