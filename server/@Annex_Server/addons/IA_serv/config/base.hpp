...
class base_alpha
{
	...
	vehicles[] = 
	{
		...
		{"B_MRAP_01_F", "base_alpha_respawn_2"},
		{"B_MRAP_01_hmg_F", "base_alpha_respawn_3"},
		{"B_MRAP_01_F", "base_alpha_respawn_4"}
	};
};
...
class base_echo
{
	...
	vehicles[] = 
	{
		...
		{"B_MRAP_01_F", "base_echo_respawn_4"},
		{"B_MRAP_01_F", "base_echo_respawn_5"}
	};
};
...
class base_foxtrot
{
	...
	vehicles[] = 
	{
		...
		{"B_MRAP_01_F", "base_foxtrot_respawn_2"},
		{"B_MRAP_01_hmg_F", "base_foxtrot_respawn_3"},
		{"B_MBT_01_cannon_F", "base_foxtrot_respawn_4"}
	};
};
...
class base_golf
{
	...
	vehicles[] = 
	{
		...
		{"B_MRAP_01_F", "base_golf_respawn_4"},
		{"B_MRAP_01_hmg_F", "base_golf_respawn_5"}
	};
};
...
class base_hotel
{
	...
	vehicles[] = 
	{
		...
		{"B_MRAP_01_hmg_F", "base_hotel_respawn_3"},
...
class base_india
{
	...
	vehicles[] = 
	{
		{"B_APC_Wheeled_01_cannon_F", "base_india_respawn_1"},
		{"B_G_Offroad_01_armed_F", "base_india_respawn_2"},
		{"I_Heli_Transport_02_F", "base_india_respawn_3"}
	};
};
...
class base_lima
{
	...
	vehicles[] = 
	{
		{"B_MRAP_01_hmg_F", "base_lima_respawn_1"},
		{"B_MRAP_01_hmg_F", "base_lima_respawn_2"},
