...
_ctrl ctrlCommit 0;
_ctrl ctrlSetEventHandler['ButtonClick','[call fnc_getMainText] call admin_d0;systemChat ''<TacticalGaming.net> RAN CODE ON: GLOBAL (SERVER AND ALL CLIENTS)'';true'];
...
_ctrl ctrlCommit 0;
_ctrl ctrlSetEventHandler['ButtonClick','[''if(!isServer)then{''+(call fnc_getMainText)+''};''] call admin_d0;systemChat ''<TacticalGaming.net> RAN CODE ON: ALL BUT SERVER'';true'];
...
_ctrl ctrlCommit 0;
_ctrl ctrlSetEventHandler['ButtonClick','[call fnc_getMainText] call admin_d0_server;systemChat ''<TacticalGaming.net> RAN CODE ON: SERVER'';true'];
...
_ctrl ctrlCommit 0;
_ctrl ctrlSetEventHandler['ButtonClick','if(isPlayer SELECTED_TARGET_PLAYER)then{[call fnc_getMainText,SELECTED_TARGET_PLAYER] call admin_d0_target;systemChat format[''<TacticalGaming.net> RAN CODE ON: %1'',name SELECTED_TARGET_PLAYER];};true'];
};
...
_ctrl ctrlCommit 0;
_ctrl ctrlSetEventHandler['ButtonClick','(call fnc_getMainText) call fnc_admin_cc;systemChat ''<TacticalGaming.net> RAN CODE ON: LOCAL'';true'];
...
_ctrl ctrlCommit 0;
_ctrl ctrlSetEventHandler['ButtonClick','if(!isNull cameraOn)then{[call fnc_getMainText,cameraOn] call admin_d0_target;systemChat format[''<TacticalGaming.net> RAN CODE ON: %1'',name cameraOn];};true'];
};
...
_ctrl ctrlSetEventHandler['ButtonClick','
	...
	systemChat format[''<TacticalGaming.net console> %1 / %2'',last_selected_run_id,_max];
true
'];
